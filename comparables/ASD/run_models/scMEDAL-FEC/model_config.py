...
compile_dict = {
    ...
    "loss_recon_weight": 2000,  # Weight for reconstruction loss
...
build_model_dict = {
    ...
    "get_pred": True,            # Enable celltype classification loss
...
# --------------------------------------------------------------------------------------
get_scores_dict = {
    "encoder_latent_name": "scMEDAL-FEC_latent_2",  # Encoder latent space name
