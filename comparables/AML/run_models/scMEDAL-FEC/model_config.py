...
build_model_dict = {
    ...
    "get_pred": True,  # Enable cell type classification
...
# --------------------------------------------------------------------------------------
get_scores_dict = {
    "encoder_latent_name": "scMEDAL-FEC_latent_2",  # Latent space name
...
plot_params = {
    ...
    "showplot": False,
    "save_fig": True,
    "outpath": None  # To be updated after defining paths
}

# --------------------------------------------------------------------------------------
# 9. Construct Data Paths
# --------------------------------------------------------------------------------------
