#!/bin/bash
#SBATCH --job-name=AE_RE
#SBATCH --time=14-00:00:00
# Specify type of nodes, number of nodes, and number of CPUs, GPUs per node
#SBATCH --partition=GPUp100
#SBATCH --nodes=2
#SBATCH --exclude=Nucleus162
...
python run_AE_RE_allfolds_Raytune_6.py
