...
cm_multibatch_name = f"CMmultibatch_{n_cells_per_batch}_cells_per_batch_{n_batches}batches" if celltype_name is None else f"CMmultibatch_{n_cells_per_batch}_cells_per_batch_{n_batches}batches_{celltype_name}"
if add_inputs_fe:
