from .utils import asinh, sinh, lrelu, tbn, obn, calculate_mmd
...
class SAUCIE(object):
    ...
    def _build_layers(self):
        ...
        if self.lambda_b:
            ...
            latent_dim = self.layers[-1]
            print("latent_dim",latent_dim)
            self.embedded = tf.layers.dense(h3, latent_dim, activation=tf.identity, name='embedding', use_bias=True)
