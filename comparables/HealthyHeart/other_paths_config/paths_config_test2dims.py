...
if expt == "expt_test":
    ...
    if calculate_clustering_scores:
        run_names_dict.update({
            ...
            "scVI":"run_crossval_n_latent_dims-2_n_layers-2_n_hidden-128_gene_likelihood-zinb_dispersion-gene_scaling-min_max_batch_size-512_epochs-2_patience-30_compute_latents_callback-False_sample_size-10000_model_type-ae_n_components-2_2025-05-07_22-19"
        })
