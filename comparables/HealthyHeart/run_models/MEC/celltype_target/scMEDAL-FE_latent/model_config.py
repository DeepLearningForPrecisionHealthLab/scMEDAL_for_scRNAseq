...
build_model_dict = {
    ...
    "layer_units": [8, 4],
    "n_pred": 13,
    "add_re_2_meclass": False,  # If False, KL-related args are ignored
    "name": "mec"  # Model name
}
...
load_data_dict = {
    ...
    "scaling": None     # Input data scaling: "min_max" or "z_scores"
}
...
train_model_dict = {
    "batch_size": 512,
    "epochs": 2,            # For testing; for full experiments use larger epochs (e.g., 100)
    # "epochs": 200,
...
expt_design_dict = {
    'batch_col': 'batch',
    'bio_col': 'celltype'  # Predicting patient group: AML, healthy, cell line
}
...
LatentClassifier_config = {
    ...
    'latent_keys_config': {
        'fe_latent': 'scMEDAL-FE_latent' # Using only fe
    },
    'return_metrics': True,
...
load_latent_spaces_dict = {
    ...
    'model_params': None,
    'base_path': None,  # Defined later
    'fold': 2, # This is temporary, later we loop throgh all the folds in mec_allfolds.py
    'models_list': ["scMEDAL-RE", "scMEDAL-FE", "scMEDAL-FEC", "AEC", "AE"],
...
constant_keys = [
    ...
    "layer_units", "name", "monitor_metric", "stop_criteria", "get_pca",
    "get_baseline", 'encoder_latent_name', 'sigmoid_eval_test', 'last_activation',
    'get_pred', "eval_test", "optimizer", "loss", "loss_weights", "metrics",
    "add_re_2_meclass"
]
