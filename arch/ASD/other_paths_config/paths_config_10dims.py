...
if expt == "expt_50dims":
    ...
    run_names_dict = {
        "scMEDAL-RE_10dims":"run_crossval_loss_recon_weight-110.0_loss_latent_cluster_weight-0.1_n_latent_dims-10_layer_units-512-132_kl_weight-0.0_scaling-min_max_batch_size-512_epochs-500_patience-30_sample_size-10000_2025-06-01_18-20",
    ...
    if calculate_clustering_scores:
        run_names_dict.update({
            "AE_10dims":"run_crossval_n_latent_dims-10_layer_units-512-132_use_batch_norm-True_scaling-min_max_batch_size-512_epochs-500_patience-30_compute_latents_callback-False_sample_size-10000_model_type-ae_n_components-10_2025-06-01_18-47",

            "scMEDAL-FE_10dims":"run_crossval_loss_gen_weight-1_loss_recon_weight-1000_loss_class_weight-1_n_latent_dims-10_layer_units-512-132_use_batch_norm-True_scaling-min_max_batch_size-512_epochs-500_patience-30_sample_size-10000_model_type-ae_da_2025-06-01_17-49",

            "scVI_10dims":"run_crossval_n_latent_dims-10_n_layers-2_n_hidden-132_gene_likelihood-zinb_dispersion-gene_scaling-min_max_batch_size-512_epochs-500_patience-30_compute_latents_callback-False_sample_size-10000_model_type-ae_n_components-10_2025-06-01_18-45"
