...
from path2results import results_path_dict,run_names_dict,compare_models_path,data_base_path, scenario_id,input_base_path,path2results_file,scaling
import gc
import shutil
import random


from model_train_utils import ModelManager,run_model_pipeline_LatentClassifier_v2,calculate_metrics_with_ci
...
for fold in folds_list:
    ...
    results = run_model_pipeline_LatentClassifier_v2(**pipeline_LatentClassifier_config)
