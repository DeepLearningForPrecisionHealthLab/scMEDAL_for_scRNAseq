...
build_model_dict = {
    ...
    "layer_units": [8, 4],
    "n_pred": 3,
    "add_re_2_meclass": False,  # If False, KL-related arguments are ignored
    "name": "mec"  # Model name to use
}
...
# --------------------------------------------------------------------------------------
load_data_dict = {
    "eval_test": True,  # Set to True if test data should be loaded
    "scaling": None  # Scaling options: "min_max", "z_scores", or None
}
...
# --------------------------------------------------------------------------------------
get_scores_dict = {
    "encoder_latent_name": "MEC_latent",  # Modify based on the model
    "get_pca": False,
    "get_baseline": False,
    "n_components": 2
}
...
expt_design_dict = {
    ...
    'bio_col': 'Patient_group'  # Biological condition (e.g., AML, healthy, cell line)
}
...
# Update load_latent_spaces_dict with experimental design parameters
...
run_name = generate_run_name(
    ...
    constant_keys=None,
    name='run_latent_classifier_ptGroup'
)
