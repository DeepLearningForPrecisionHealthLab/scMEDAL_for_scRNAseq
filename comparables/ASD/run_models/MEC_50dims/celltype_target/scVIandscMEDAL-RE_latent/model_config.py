...
LatentClassifier_config = {
    ...
    'latent_keys_config': {
        'fe_latent': 'scVI_50dims_latent', #'modelname_latent'
...
load_latent_spaces_dict = {
    ...
    'models_list': ["scMEDAL-RE_50dims","scVI_50dims"],# model_name for each scMEDAL-RE and scVI
...
run_name = generate_run_name(
    ...
    constant_keys=None,
    name='run_latent_classifier_scVI'
)
