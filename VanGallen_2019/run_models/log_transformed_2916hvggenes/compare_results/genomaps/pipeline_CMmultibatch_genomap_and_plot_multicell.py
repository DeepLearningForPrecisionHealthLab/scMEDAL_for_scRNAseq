...
cm_multibatch_name = f"CMmultibatch_{n_cells_per_batch}_cells_per_batch_{n_batches}batches" if not celltype_name else f"CMmultibatch_{n_cells_per_batch}cells_per_batch_{n_batches}batches_{celltype_name}"
