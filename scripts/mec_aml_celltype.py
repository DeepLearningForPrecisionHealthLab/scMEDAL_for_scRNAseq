...
# classification targets: 21 celltypes 



# Run MEC on scmedalfe , target: 21 celltype
...
# Run MEC on scmedalfe + scmedalre, target: 21 celltype
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
...
# Run MEC on PCA, target: 21 celltype
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
...
# Run MEC on PCA+scmedalre, target: 21 celltype
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
...
# Run MEC  target: 21celltype, latent spaces :scvi
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
...
# Run MEC  target: 21 celltype, latent spaces :scvi+scmedalre
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
...
# Run MEC  target: 21 celltype, latent spaces :scanorama+scmedalre
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
...
# Run MEC  target: 21 celltype, latent spaces :scanorama
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
...
# Run MEC  target: 21 celltype, latent spaces :harmony
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
...
# Run MEC  target: 21 celltype, latent spaces :harmony +"scmedalre_latent"
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
...
# Run MEC  target: 21 celltype, latent spaces :"SAUCIE"
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
...
# Run MEC  target: 21 celltype, latent spaces :"SAUCIE"+"scmedalre"
mec_aml = train_model_on_named_experiment("MEC", "AML", 
                                    train_kwargs={#"quick":True, 
                                                    "results_path_dict":model_paths, },
                                    model_kwargs={"n_pred":21,
