...
from scMEDAL_for_scRNAseq.comparables.scANVI import run_scanvi_across_folds
...
#--------------------------------------------------------------------------------------
get_scores_dict = {
    "encoder_latent_name": "scANVI_latent_50", # Modify depending on the model used
    "get_pca": False,
    #"n_components": 50,
...
# 4.2 Run CV
# -------------------------------------
cv_results = run_scanvi_across_folds(
