...
# --------------------------------------------------------------------------------------
build_model_dict = {
    "n_latent_dims": 2,            # Initial latent dimensions
...
train_model_dict = {
    "batch_size": 512,
    "epochs": 2,          # For testing; use higher epochs for full experiments
    # "epochs": 500,
...
# --------------------------------------------------------------------------------------
get_scores_dict = {
    "encoder_latent_name": "scMEDAL-RE_latent_2",  # Adjust based on model
    "get_pca": False,
    "n_components": 2,
    "get_baseline": False,
