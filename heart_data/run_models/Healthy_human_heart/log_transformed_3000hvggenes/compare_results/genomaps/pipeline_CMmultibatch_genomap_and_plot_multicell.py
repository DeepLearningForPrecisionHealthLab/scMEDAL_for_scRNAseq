...
#batches_to_select_from = ['HCAHeart7888927',"H0037_Apex","HCAHeart7888925","HCAHeart7702875"]
#batches_to_select_from = ['HCAHeart7888927',"H0037_Apex","HCAHeart7888925","H0025_RA"]
...
if isinstance(celltype, str) or isinstance(celltype, list):
    ...
    cell_ids_2plot = select_cells_from_batches(obs_multibatch, celltype, batches_to_select_from, seed=seed)
...
for cell_id in cell_ids_2plot:
    ...
    original_celltype = obs_multibatch.loc[(obs_multibatch["_index"] ==cell_id)&(obs_multibatch["recon_prefix"]=="input_train"),"celltype"].values[0]
