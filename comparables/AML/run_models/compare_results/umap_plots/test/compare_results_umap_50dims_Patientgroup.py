...
umap_path = os.path.join(out_name, "umap_19batches_seed_5_Patientgroup")
if not os.path.exists(umap_path):
    os.makedirs(umap_path)

# Define filtering criteria for models and splits
filter_folds = {
    "AE_50dims": 2,
    "AEC_50dims": 2,
...
processor = DimensionalityReductionProcessor(
    ...
    scaling="min_max",
    n_batches_sample=3,
    batch_col="Patient_group",
    plot_tsne=False,
    n_pca_components=50,
    rng_seed=5,                # reproducible RNG ?  (was seed=?)
